...
public class PathResponseAssembler {
    public static PathResponse assemble(SubwayPath subwayPath, Map<Long, Station> stations, int lineFare) {
        ...
        int totalFare = subwayPath.calculateFare(distance) + lineFare;
